...
function collectDispatchPersonsFromPane() {
    const entries = document.querySelectorAll('#personsContent .person-entry');
...
function collectDispatchVehiclesFromPane() {
    const entries = document.querySelectorAll('#vehiclesContent .vehicle-entry');
    return Array.from(entries).map(entry => ([
